...
public class AutoCompleteDictionaryTrie implements  Dictionary, AutoComplete {
   ...
   // private int n;
	...
	//{
		...
		if (!curr.getChild(r).equals(null)) {
	...
	public boolean isWord(String s) 
	{
		...
		for(int i=0; i<lowerCaseWord.length(); i++) {
			char c = lowerCaseWord.charAt(i);
			Set<Character> nextPossibleChar = TN.getValidNextCharacters();
			if(nextPossibleChar.contains(c)) {
				if(i != (lowerCaseWord.length()-1)) {
					TN = TN.getChild(c);
				}
			}
