...
public abstract class Document {
	...
	private String text;//pela private hatu
	...
	public double getFleschScore()
	{
		...
		int s = getNumSyllables();
		int m =  getNumWords();
		int j =  getNumSentences();
		Double S =  Double.valueOf(s);
		Double M =  Double.valueOf(m);
		Double J =  Double.valueOf(j);
		double k = M/J;
		double l = S/M;
		System.out.println("syllabel"+s+"words"+m+"sentences"+j+"k"+k+"l"+l);
	    return (206.835-(1.015*k)-(84.6*l)) ;
	}
