...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		// OF THIS METHOD.
			...
			int idx = lastWord.length()-1;
			if(idx >=0 && lastWord.charAt(idx) != '.' && lastWord.charAt(idx)!='?' && lastWord.charAt(idx)!='!' )
				numSentences += 1;
		}
	...
	public int getNumSyllables() {
        //TODO: write this method.  Hint: It's simple
		//int Syll = Document.getNumSyllables();
		return numSyllables;
